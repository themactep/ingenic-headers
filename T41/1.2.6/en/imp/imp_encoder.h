 ...
 *
 * high 6 bits:
 * The range of values when using Map-Roi relative mode is [-32,31], and the complement representation is used to represent positive and negative numbers:111111=-1;111110=-2;111101=-3;...;100000=-32;
