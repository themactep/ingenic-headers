...
typedef enum {
	...
	AUDIO_BIT_WIDTH_24 = 24,		/**< 24bit sampling precision*/
} IMPAudioBitWidth;
...
/**
 * Define the processing order of audio recording algorithms.
 */
typedef enum {
	AI_MODULE_NS = 0,
	AI_MODULE_AGC,
...
/**
 * Define the processing order of audio playing algorithms.
 */
typedef enum {
	 AO_MODULE_HPF = 0,
	 AO_MODULE_AGC,
 ...
 * Change the processing order of AI(NS/AGC/HPF) algorithms.
 * @param[in] audioDevId audio device number.
 * @param[in] aiChn audio input channel number.
 * @param[in] order[] the processing order of algorithms
 ...
 * Get the processing order of AI(NS/AGC/HPF) algorithms.
 * @param[in] audioDevId audio device number.
 * @param[in] aiChn audio input channel number.
 * @param[out] current processing order of algorithms
 ...
 * Change the processing order of AO(AGC/HPF) algorithms.
 * @param[in] audioDevId audio device number.
 * @param[in] aoChn audio input channel number.
 * @param[in] order[] the processing order of algorithms
 ...
 * Get the processing order of AO(AGC/HPF) algorithms.
 * @param[in] audioDevId audio device number.
 * @param[in] aoChn audio input channel number.
 * @param[out] current processing order of algorithms
 ...
 * @param[in] audioDevId audio device number.
 * @param[in] aiChn audio input channel number.
 * @param[in] codec audio channel parameters.
	SELECT_EXTERNAL：external codec
	SELECT_INTERNAL: internal codec
	SELECT_INTERNAL_MIC_EXTERNAL_SPK：internal codec recording and external codec playback
	SELECT_INTERNAL_SPK_EXTERNAL_MIC：internal codec playback and external codec recording
