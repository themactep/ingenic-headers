...
typedef enum {
	...
	DMIC_BIT_WIDTH_24 = 24, /**<24 bit sampling precision*/
} IMPDmicBitWidth;
...
/**
 * @fn IMP_DMIC_EnableAgc(IMPDmicAttr *attr, IMPAudioAgcConfig agcConfig)
 *
 ...
 *
 * Disable DMIC automatic gain feature.
 *
 * @param no.
 *
 * @retval 0 success.
 ...
 *
 * Disable DMIC high pass filtering function.
 *
 * @param no.
 *
 * @retval 0 success.
